...
def main():
    ...
    st.write("""
    Welcome to **What's App Chat Analyzer** - Your Personal WhatsApp Chat Insight Engine!
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("© 2023 **What's App Chat Analyzer** Made By Krish Gupta. All rights reserved.")
